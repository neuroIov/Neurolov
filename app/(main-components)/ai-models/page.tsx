...
const DEV_EMAILS = [
  'nitishmeswal@gmail.com',
  'neohex262@gmail.com',
  'test@example.com',
  'jprateek961@gmail.com',
  'bhaveshshukla2003@gmail.com'
];
                      ...
                      <Image
                        src={`/ai-models/${
                          model.id === 'neurolov-image'
                            ? 'neuro-image-gen'
                            : model.id === 'text-to-video' || model.id === 'video'
                            ? 'ai-video'
                            : model.id === 'music-ai'
                            ? 'ai-music'
                            : 'neuro-image-gen'
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-gray-800">
                        ...
                        >
                          <Heart
                            className={`w-4 h-4 ${
                              modelLikes[model.id]?.isLiked ? 'fill-red-500 text-red-500' : ''
                            }`}
                          />
                ...
                deployedContainers.map((container) => (
                  ...
                  >
                    ...
                    <div className="relative h-40">
                      <Image
                        src={`/ai-models/${
                          container.model_name === 'neurolov-image'
                            ? 'neuro-image-gen'
                            : container.model_name === 'text-to-video' || container.model_name === 'video'
                            ? 'ai-video'
                            : container.model_name === 'music-ai'
                            ? 'ai-music'
                            : 'neuro-image-gen'
                        }.png`}
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex items-center justify-between pt-2 border-t border-gray-800">
                        ...
                        >
                          <Heart
                            className={`w-4 h-4 ${
                              modelLikes[container.model_name]?.isLiked ? 'fill-red-500 text-red-500' : ''
                            }`}
                          />
